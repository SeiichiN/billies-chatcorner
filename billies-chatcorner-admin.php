...
function billies_chatcorner_admin_add_files () {
  ...
  wp_enqueue_script('js-billies-chatcorner-socket', 'http://localhost:3000/socket.io/socket.io.js', array(), false, false);
  ...
  wp_enqueue_script('js-billies-chatcorner-data', plugins_url('js/billiesChatcorner.data.js', __FILE__), array('jquery'), false, true);
